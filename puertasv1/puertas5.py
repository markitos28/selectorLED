...
try:
    arduino = serial.Serial('COM6', 9600, timeout=1)  # cambia COM6 si es necesario
    time.sleep(2)
...
with mp_hands.Hands(max_num_hands=2, min_detection_confidence=0.7) as hands:
    while True:
        ...
        # Enviar solo si cambia el estado o el brillo
        ...
        # Mostrar estado de servos
        if dedos_right[3] == 1:
            cv2.putText(image, "Servo 1 (pin 10) activo", (50, 200),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 255), 2)
        if dedos_right[4] == 1:
            cv2.putText(image, "Servo 2 (pin 11) activo", (50, 240),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 255), 2)
